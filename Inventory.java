...
class Inventory
{
	...
	public Inventory()
	{
		Item i1 = new Item(8, 64, 0);
		Item i2 = new Item(4, 54, 1);
		Item i3 = new Item(3, 32, 2);
		Item i4 = new Item(11, 11, 3);
		Item i5 = new Item(10, 42, 4);
		Item i6 = new Item(12, 12, 5);
		Item i7 = new Item(15, 21, 6);
		Item i8 = new Item(9, 9, 7);
		Item i9 = new Item(19, 23, 8);
		...
		Item i10 = new Item(14, 34, 9);
		inventory.add(i10);
		Item i11 = new Item(15, 34, 10);
		inventory.add(i11);
		Item i12 = new Item(16, 34, 11);
		inventory.add(i12);
		Item i13 = new Item(17, 34, 12);
		inventory.add(i13);
		Item i14 = new Item(14, 34, 13);
		inventory.add(i14);
		Item i15 = new Item(15, 34, 14);
		inventory.add(i15);
		Item i16 = new Item(16, 34, 15);
		inventory.add(i16);
		Item i17 = new Item(17, 34, 19);
		inventory.add(i17);
		Item i18 = new Item(14, 34, 20);
		inventory.add(i18);
		Item i19 = new Item(15, 34, 30);
		inventory.add(i19);
		Item i20 = new Item(16, 34, 21);
		inventory.add(i20);
		Item i21 = new Item(17, 34, 22);
		inventory.add(i21);
		Item i22 = new Item(14, 34, 24);
		inventory.add(i22);
		Item i23 = new Item(15, 34, 29);
		inventory.add(i23);
		Item i24 = new Item(16, 34, 34);
		inventory.add(i24);
		Item i25 = new Item(17, 34, 35);
		inventory.add(i25);
